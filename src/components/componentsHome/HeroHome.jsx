...
const variants = {
  visible: { scale: 1.3, opacity: 1, transition: { duration: 0.8, ease: "easeOut" } },
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
          <div  className="w-full max-w-3xl text-center">
            ...
            <h1 className="text-2xl text-start font-semibold">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est commodi quia atque. Iusto, totam laboriosam facilis dolores corporis nobis temporibus tempore praesentium libero eligendi! Fugit delectus necessitatibus nostrum! Vel, eius.
            </h1>
            ...
            className="flex justify-start mt-8  flex-wrap  gap-4">
              <a
                className="block w-full rounded-full border border-pink-600 bg-gradient-to-r from-pink-500 via-blue-500 to-purple-600 px-24 py-3 text-2xl font-medium text-white  focus:outline-none focus:ring active:text-opacity-75 sm:w-auto hover:bg-white "
                href="#"
              >
                Portafolio
              </a>
          ...
          <motion.div className="md:block md:w-1/2 py-4" 
